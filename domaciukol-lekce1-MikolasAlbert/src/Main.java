...
public class Main {
String sellerNameSurname = "Karel Novak";
LocalDate dateOfTheSeller = LocalDate.of(1980, 3, 18);
int numberOrders = 39;
double soldCarrotInTons = 3.45;
String sellersCity = "Prague";
double companyCarConsumptionPer100km = 5.32;
String licencePlateNumber = "ABC1013";
String ipAdress = "192.59.39.20";
